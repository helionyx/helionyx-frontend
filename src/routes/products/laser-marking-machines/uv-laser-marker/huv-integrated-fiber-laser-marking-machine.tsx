...
const ProductDetail: React.FC = () => {
	...
	const productName = t('products.huv-integrated-fiber-laser-marking-machine.name').toUpperCase()
	const benefitsTitle = t('constants.name.appDesc') + ' ' + productName

	const benefits = [
		{
			title: t('products.huv-integrated-fiber-laser-marking-machine.advantages.fastAndAccurateLaserMarking.title'),
			description: t(
				'products.huv-integrated-fiber-laser-marking-machine.advantages.fastAndAccurateLaserMarking.description'
			)
		},
		{
			title: t('products.huv-integrated-fiber-laser-marking-machine.advantages.versatileAndDurableMarking.title'),
			description: t(
				'products.huv-integrated-fiber-laser-marking-machine.advantages.versatileAndDurableMarking.description'
			)
		},
		{
			title: t('products.huv-integrated-fiber-laser-marking-machine.advantages.costEffectiveAndEcoFriendly.title'),
			description: t(
