...
import image_1 from '@/assets/laser-marking-machines/uv-laser-marker/HUV-FW UV Flying Laser Marking Machine (JPT Laser Source)/Huv-fw-Scope-pictures-1.png'
import image_2 from '@/assets/laser-marking-machines/uv-laser-marker/HUV-FW UV Flying Laser Marking Machine (JPT Laser Source)/Huv-fw-Simple-of-application-2.png'
...
const ProductScopeApplication: React.FC = () => {
		...
		<Card>
			...
			<CardContent>
				<section className='flex flex-col'>
					<img src={image_1} alt='product scope application' />
				</section>
			</CardContent>
		</Card>
	)
...
const ProductSample: React.FC = () => {
	...
	return (
		<Card>
			...
			<CardContent>
				<section className='flex flex-col'>
					<img src={image_2} alt='product sample' />
				</section>
			</CardContent>
		</Card>
	)
