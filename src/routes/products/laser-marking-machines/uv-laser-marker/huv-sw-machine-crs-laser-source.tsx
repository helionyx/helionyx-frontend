...
import uv_laser_marking_machine_1 from '@/assets/laser-marking-machines/uv-laser-marker/HUV-SW Machine (CRS Laser Source)/Huv-sw-marking-machine-1.jpg'
import uv_laser_marking_machine_2 from '@/assets/laser-marking-machines/uv-laser-marker/HUV-SW Machine (CRS Laser Source)/Huv-sw-marking-machine-2.jpg'
import uv_laser_marking_machine_3 from '@/assets/laser-marking-machines/uv-laser-marker/HUV-SW Machine (CRS Laser Source)/Huv-sw-marking-machine-3.jpg'
import uv_laser_marking_machine_4 from '@/assets/laser-marking-machines/uv-laser-marker/HUV-SW Machine (CRS Laser Source)/Huv-sw-marking-machine-4.jpg'
import uv_laser_marking_machine_5 from '@/assets/laser-marking-machines/uv-laser-marker/HUV-SW Machine (CRS Laser Source)/Huv-sw-marking-machine-5.jpg'
...
const ProductDetail: React.FC = () => {
	...
	const applicationImages = [
		{
			image: uv_laser_marking_machine_1,
			imageAlt: 'uv laser marking machine 1'
		}
	]

	const sampleImages = [
		{
			image: uv_laser_marking_machine_2,
			imageAlt: 'uv laser marking machine 2'
		},
		{
			image: uv_laser_marking_machine_3,
			imageAlt: 'uv laser marking machine 3'
		},
		{
			image: uv_laser_marking_machine_4,
			imageAlt: 'uv laser marking machine 4'
		},
		{
			image: uv_laser_marking_machine_5,
			imageAlt: 'uv laser marking machine 5'
		}
	]
