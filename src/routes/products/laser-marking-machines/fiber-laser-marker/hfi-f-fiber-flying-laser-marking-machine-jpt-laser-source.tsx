...
import hfi_f_1 from '@/assets/laser-marking-machines/fiber-laser-marker/HFI-F Fiber Flyinh Laser Marking Machine (JPT Laser Source)/Hfi-f-1.png'
import hfi_f_2 from '@/assets/laser-marking-machines/fiber-laser-marker/HFI-F Fiber Flyinh Laser Marking Machine (JPT Laser Source)/Hfi-f-2.png'
import hfi_f_3 from '@/assets/laser-marking-machines/fiber-laser-marker/HFI-F Fiber Flyinh Laser Marking Machine (JPT Laser Source)/Hfi-f-3.png'
...
const ProductDetail: React.FC = () => {
	...
	const applicationImages = [
		{
			image: hfi_f_1,
			imageAlt: 'HFI-F Fiber Flyinh Laser Marking Machine (JPT Laser Source)'
		}
	]
